...
class Conector:
    ...
    def consultaAsistente(self):
        ...
        sql = "select a.idagenda, p.nombre, a.TemaReunion, a.lugar, a.fecha, a.hora from persona p inner join agenda a on a.idpersona = p.idpersona where p.nombre Like '%s'" %asistente
        self.coneccion.cursor.execute(sql)

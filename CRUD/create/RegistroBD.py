...
class RegistroDB:
    ...
    def InsertarEvento(self,idAgenda,temaReunion,lugar,fecha,hora):
        sql = "insert into reunion (idReunion,temaReunion,lugar,fecha,hora) values({},'{}','{}','{}','{}')".format(idAgenda,temaReunion,lugar,fecha,hora)
        self._registro.cursor.execute(sql)
        print("Ingresado correctamente ")
        self._registro.cursor.connection.commit()
        os.system('pause')
